...
console.log("/src/views/DesignEditor/components/Navbar/DesignTitle file start ");
interface State {
  name: string
  width: number
}
...
const DesignTitle = () => {
  ...
  console.log("/src/views/DesignEditor/components/Navbar/DesignTitle component start ");
  const handleInputChange = (name: string) => {
    console.log("/src/views/DesignEditor/components/Navbar/DesignTitle component handleInputChange ");
  ...
  React.useEffect(() => {
    ...
    console.log("/src/views/DesignEditor/components/Navbar/DesignTitle component React.useEffect currentDesign.name",currentDesign.name);
...
console.log("/src/views/DesignEditor/components/Navbar/DesignTitle file end ");